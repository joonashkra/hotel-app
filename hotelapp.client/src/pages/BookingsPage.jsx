...
export default function BookingsPage() {
  ...
  return (
    <div className='bookingsPage'>
        <nav id='RoomsNavBar'>
            <a className={`roomsNavLink ${isBookingsView ? 'active' : ''}`} onClick={switchView}>Bookings</a>
            <a className={`roomsNavLink ${!isBookingsView ? 'active' : ''}`} onClick={switchView}>Book Room</a>
        </nav>
